...
def get_loader_test(source_path,
                    target_path,
                    evaluation_path,
                    transforms,
                    batch_size=32):
    ...
    target_folder_train = ImageFolder(os.path.join(target_path),
                                      ...
                                      return_paths=False,
                                      train=True)
    eval_folder_test = ImageFilelist(
        os.path.join(evaluation_path),
    ...
    test_loader = torch.utils.data.DataLoader(eval_folder_test,
